...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-h3mxppy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-h3mxppy.containers.anotherwebservice.com/
...
```
git clone git@github.com:Arti-dos/container-h3mxppy.git
cd container-h3mxppy
```
...
```
docker attach container-h3mxppy
```
